...
import { EmailIcon, GitHubIcon, LinkedinIcon, ProjectsIcon, ReactIcon } from "./icons";
...
export default function Navbar(props: PropsNavbarInterface) {
  return (
    <div
      className={twMerge(
        "flex bg-black2 justify-between px-5 w-full h-14",
        "text-lightblue items-center font-bold text-lg shadow-lg",
        props.switchMode && "bg-transparent text-black"
      )}
    >
      <div className="flex gap-1 select-none items-center ease-in-out duration-200">
        <ReactIcon
          classname={twMerge("fill-lightblue ease-in-out duration-200", props.switchMode && "fill-black")}
          width={30}
          height={30}
      ...
      <div className="flex gap-4">
        <div
          className={twMerge(
            ...
            "ease-in-out duration-200 hover:scale-110 hover:brightness-150"
          )}
        >
          <LinkedinIcon
            classname={twMerge("fill-lightblue ease-in-out duration-200", props.switchMode && "fill-black")}
